...
const Image: React.FC<ImageProps> = ({ alt, src }) =>
  <img alt={alt} src={src} className="home-image" />

const Home: React.FC = () => 
  <div>
    <Image src={images.twilight} alt="Front of the house at twilight" />
    ...
    <Image src={images.lakeSailboats} alt="View of sailboats in Lake Champlain from the back deck" />
    ...
    <Image src={images.winterSnow} alt="Snow falling off the front of the house in winter" />
    ...
    <Image src={images.houseFront} alt="The front of the house during the day in summer" />
    ...
    <Image src={images.bedroom} alt="A bedroom looking very tidy" />
  </div>
